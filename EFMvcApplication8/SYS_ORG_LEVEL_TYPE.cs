...
namespace EFMvcApplication8
{
    ...
    public partial class SYS_ORG_LEVEL_TYPE
    {
        public SYS_ORG_LEVEL_TYPE()
        {
            this.ADM_ORG_LEVEL = new HashSet<ADM_ORG_LEVEL>();
        }
        ...
        public virtual ICollection<ADM_ORG_LEVEL> ADM_ORG_LEVEL { get; set; }
    }
}
