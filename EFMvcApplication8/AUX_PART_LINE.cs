...
namespace EFMvcApplication8
{
    ...
    public partial class AUX_PART_LINE
    {
        public AUX_PART_LINE()
        {
            this.AUX_PART_BRAND = new HashSet<AUX_PART_BRAND>();
        }
        ...
        public virtual ICollection<AUX_PART_BRAND> AUX_PART_BRAND { get; set; }
    }
}
