...
namespace EFMvcApplication8
{
    ...
    public partial class AUX_PART_BRAND
    {
        public AUX_PART_BRAND()
        {
            this.AUX_PART_COMPONENT = new HashSet<AUX_PART_COMPONENT>();
        }
        ...
        public virtual AUX_PART_LINE AUX_PART_LINE { get; set; }
        public virtual ICollection<AUX_PART_COMPONENT> AUX_PART_COMPONENT { get; set; }
    }
}
